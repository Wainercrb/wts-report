...
- C:\Users\WainerRodriguezBonil\.agents\skills
- C:\Users\WainerRodriguezBonil\.config\opencode\skills
- C:\Users\WainerRodriguezBonil\.copilot\skills
...
### branch-pr
- Path: C:\Users\WainerRodriguezBonil\.config\opencode\skills\branch-pr\SKILL.md
...
### chained-pr
- Path: C:\Users\WainerRodriguezBonil\.config\opencode\skills\chained-pr\SKILL.md
...
- Path: C:\Users\WainerRodriguezBonil\.config\opencode\skills\cognitive-doc-design\SKILL.md
...
### comment-writer
- Path: C:\Users\WainerRodriguezBonil\.config\opencode\skills\comment-writer\SKILL.md
...
### farm-backend-architecture
- Path: C:\Users\WainerRodriguezBonil\.agents\skills\farm-backend-architecture\SKILL.md
- Trigger: Domain-Driven Design patterns for backend architecture. Use when designing backend services or implementing new API endpoints.
- Rules:
...
### farm-backend-requirements
- Path: C:\Users\WainerRodriguezBonil\.agents\skills\farm-backend-requirements\SKILL.md
- Trigger: Functional and non-functional backend requirements for the Farm Management System. Use when defining backend requirements.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### farm-database-design
- Path: C:\Users\WainerRodriguezBonil\.agents\skills\farm-database-design\SKILL.md
- Trigger: Database schema and ER diagram for the Farm Management System. Use when designing database or creating migrations.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### farm-frontend-architecture
- Path: C:\Users\WainerRodriguezBonil\.agents\skills\farm-frontend-architecture\SKILL.md
- Trigger: Atomic Design methodology for organizing React components. Use when designing frontend architecture or creating new components.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### farm-frontend-requirements
- Path: C:\Users\WainerRodriguezBonil\.agents\skills\farm-frontend-requirements\SKILL.md
- Trigger: UI/UX requirements and features for the Farm Management System frontend. Use when defining frontend requirements or implementing new UI features.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### farm-rbac
- Path: C:\Users\WainerRodriguezBonil\.agents\skills\farm-rbac\SKILL.md
- Trigger: Role-Based Access Control patterns for the Farm Management System. Use when implementing user roles and permissions.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### farm-security
- Path: C:\Users\WainerRodriguezBonil\.agents\skills\farm-security\SKILL.md
- Trigger: Authentication, authorization, and security best practices for the Farm Management System. Use when implementing security features.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### farm-system
- Path: C:\Users\WainerRodriguezBonil\.agents\skills\farm-system\SKILL.md
- Trigger: Problem statement, objectives, and scope for the Farm Management System. Use when planning new features or understanding project context.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### find-skills
- Path: C:\Users\WainerRodriguezBonil\.agents\skills\find-skills\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### go-testing
- Path: C:\Users\WainerRodriguezBonil\.config\opencode\skills\go-testing\SKILL.md
...
### issue-creation
- Path: C:\Users\WainerRodriguezBonil\.config\opencode\skills\issue-creation\SKILL.md
...
### judgment-day
- Path: C:\Users\WainerRodriguezBonil\.config\opencode\skills\judgment-day\SKILL.md
...
### skill-creator
- Path: C:\Users\WainerRodriguezBonil\.config\opencode\skills\skill-creator\SKILL.md
...
### work-unit-commits
- Path: C:\Users\WainerRodriguezBonil\.config\opencode\skills\work-unit-commits\SKILL.md
