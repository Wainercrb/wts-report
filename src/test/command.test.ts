...
suite('utils/command.ts', () => {
  ...
  suite('executeCommand()', () => {
     ...
     */
    suite('successful execution', () => {
      test('should execute a command and resolve with stdout when exit code is 0', async () => {
        // Arrange
      ...
      test('should handle multi-line stdout output correctly', async () => {
        // Arrange
        const mockProcess: MockChildProcess = {
          stdout: new EventEmitter(),
          stderr: new EventEmitter(),
      ...
      test('should buffer stdout from multiple data events correctly', async () => {
        // Arrange
        const mockProcess: MockChildProcess = {
          stdout: new EventEmitter(),
          stderr: new EventEmitter(),
      ...
      test('should capture stderr separately and not include it in stdout', async () => {
        // Arrange
        const mockProcess: MockChildProcess = {
          stdout: new EventEmitter(),
          stderr: new EventEmitter(),
    ...
    suite('error handling', () => {
      test('should resolve with error message when exit code is non-zero and stderr exists', async () => {
        // Arrange
        const mockProcess: MockChildProcess = {
          stdout: new EventEmitter(),
          stderr: new EventEmitter(),
      ...
      test('should resolve with stderr when exit code is non-zero', async () => {
        // Arrange
        const mockProcess: MockChildProcess = {
          stdout: new EventEmitter(),
          stderr: new EventEmitter(),
      ...
      test('should resolve with error message when spawn emits error event', async () => {
        // Arrange
        const mockProcess: MockChildProcess = {
          stdout: new EventEmitter(),
          stderr: new EventEmitter(),
     ...
     */
    suite('edge cases', () => {
      test('should handle empty stdout and resolve with empty string', async () => {
        // Arrange
        const mockProcess: MockChildProcess = {
          stdout: new EventEmitter(),
          stderr: new EventEmitter(),
      ...
      test('should handle commands with special characters in arguments', async () => {
        // Arrange
        const mockProcess: MockChildProcess = {
          stdout: new EventEmitter(),
          stderr: new EventEmitter(),
      ...
      test('should pass correct command and cwd to spawn', async () => {
        // Arrange
        const mockProcess: MockChildProcess = {
          stdout: new EventEmitter(),
          stderr: new EventEmitter(),
