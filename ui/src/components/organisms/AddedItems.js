        ...
        <div className="w-full bg-white border border-gray-100 rounded-lg overflow-hidden">
          ...
          <div className="border-t border-gray-100">
            {itemsList.map((item) => (
              <div
                key={item.id}
                className="px-6 py-3 border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 flex items-center justify-between last:border-b-0"
              >
